...
Place in the bomberman_rl/ root and run:
    ...
    python plot_training.py --csv agent_code/agent/training_stats.csv
...
if __name__ == '__main__':
    ...
    parser.add_argument('--csv',    default='agent_code/agent/training_stats.csv',
                        help='path to training_stats.csv (default: agent_code/agent/training_stats.csv)')
