...
class NStepAccumulator:
    ...
    def add_reward_to_last(self, bonus):
        ...
        already been pushed.  Windows that were emitted before the bonus arrived
        keep the un-bonused return; every window still pending in the buffer
        picks it up.  The residual bias is at most one n-step window per round.
        """
